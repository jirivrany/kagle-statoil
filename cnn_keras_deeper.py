...
reduce_lr_loss = ReduceLROnPlateau(monitor='val_loss', factor=0.1, patience=7, verbose=1, epsilon=1e-6, mode='min')
...
submission.to_csv('submission-simple3.csv', index=False)
